...
<div>
    <a href="adminHomePage" style="text-decoration: none; color: inherit;">
        <span style="font-size: 24px; font-weight: bold; text-transform: uppercase;">RESIDENSI UTMKL</span>
    </a>
</div>
        <div style="display: flex; align-items: center; margin-right: 10px;">
            <div style="text-align: center; margin-right: 10px;">
                <span style="margin-bottom: 5px; display: block;">MANAGEMENT</span>
            </div>
            <a href="managerLogout"><button style="background-color: silver; border: none; border-radius: 10px; padding: 8px 16px; font-size: 16px; cursor: pointer;">Logout</button></a>
        </div>
    </div>
